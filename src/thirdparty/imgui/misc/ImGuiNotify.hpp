...
public:
    ...
    */
    inline void setWindowFlags(const ImGuiWindowFlags& _flags)
    {
        this->flags = _flags;
    }
    ...
    */
    inline void setOnButtonPress(const std::function<void()>& _onButtonPress)
    {
