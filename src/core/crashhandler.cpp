...
constexpr char ADDTL_CRASH_INFO[] = {
	"// generated by RSX v" VERSION_STRING "\n"
...
{
	m_Buffer.append(ADDTL_CRASH_INFO);
	// Add an extra newline to ensure that the additional info isn't malformed
	// as otherwise it would run into the "crash" key.
	// Also, when the additional info is correctly formed, having an extra newline
	// looks nicer :)
	m_Buffer.append("\n");
